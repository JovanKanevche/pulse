...
#define MAX30100_I2C_ADDRESS 0x57
    ...
    typedef enum
    {
        ...
        /* FIFO write pointer */
        MAX30100_REG_FIFO_WR_PTR = 0x04,
        /* FIFO overflow counter */
        MAX30100_REG_FIFO_OVF_COUNTER = 0x05,
        /* FIFO read pointer */
        MAX30100_REG_FIFO_RD_PTR = 0x06,
        /* FIFO data */
        MAX30100_REG_FIFO_DATA = 0x07,
        /* Mode configuration */
        MAX30100_REG_MODE_CONFIG = 0x08,
        /* SPO2 configuration */
        MAX30100_REG_SPO2_CONFIG = 0x09,
        /* LED configuration */
        MAX30100_REG_LED_CONFIG = 0x0A,
        /* Temperature integer (2's compliment) */
        MAX30100_REG_TEMP_INTEGER = 0x1F,
        /* Temperature fraction) */
        MAX30100_REG_TEMP_FRACTION = 0x20,
        /* Revision ID (RO)*/
        MAX30100_REG_REV_ID = 0x21,
        /* Part ID */
